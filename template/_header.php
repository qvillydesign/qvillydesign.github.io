...
<header class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="cont-logo">
        <a href="<?php echo $baseController->website_url ?>">
            <img class="logo" src="<?php echo $baseController->website_url ?>/assets/img/logo-white1.png"
                 alt="Bunker.Online">
        </a>
    </div>
        ...
        <div class="wrap-menus ">
            <div class="cont-menu">
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                           href="<?php echo $baseController->website_url ?>/page.php?name=about">
                            О нас
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"
                           href="<?php echo $baseController->website_url ?>/page.php?name=contacts">
                            Контакты
                        </a>
                    </li>
                    |
                    ...
                    <div class="dropdown-menu dropdown-menu-right mu-dd-content" id="dropdown-cart">
                        <a href="page.php?name=cart" style="text-decoration: none;">
                            ...
                            <div class="cont-dd">
                                ...
                                <a class="dropdown-item di-btn-link" href="page.php?name=cart">Просмотр корзины</a>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="cont-menu-user nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right mu-dd-content"
                        ...
                        <a class="dropdown-item"
                           href="<?php echo $baseController->website_url ?>/page.php?name=user">Мой аккаунт</a>
                        <?php if (User::isAdmin()) { ?>
                            <a class="dropdown-item"
                               href="<?php echo $baseController->website_url ?>/page.php?name=admin-area&overview">Панель администратора</a>
                        <?php } ?>
                        <a class="dropdown-item"
                           href="<?php echo $baseController->website_url ?>/page.php?name=login&logout">Выйти</a>
                    </div>
                </div>
                <?php
            }
