        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Настройка профиля</li>
                </ol>
            </nav>
        </div>
    </section>
        ...
        <section class="flex-container-center brc fit-height-section">
            <div class="container pe-cont flex-item-center">
                <div class="col-12 cont-edit-form">
                    <h1 class="display-4">Настройка профиля</h1>
                    <form class="form-edit-login" id="form-edit-login" method="post" action="page.php?name=edit-login"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="firstName" class="form-control" id="firstName" placeholder="Имя"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="lastName" class="form-control" id="lastName" placeholder="Фамилия"
                        ...
                        <button class="btn btn-primary" name="editLogin" type="submit">Сохранить</button>
                    </form>
                </div>
            </div>
        </section>
