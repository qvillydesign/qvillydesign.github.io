                ...
                <div class="row row-offcanvas row-offcanvas-right">
                    <div class="col-12 col-md-9">
                        <input class="form-control form-control-lg" type="text" name="title"
                               placeholder="Название" value="<?php echo $product->title; ?>">
                        <br>
                        <div class="form-row">
                            <div class="col-md-6 input-group">
                                ...
                                <input name="price" class="form-control " type="number" step="any"
                                       min="0.1"
                                       placeholder="Цена" value="<?php echo $product->price; ?>" required>
                            </div>
                            <div class="col-md-6 input-group">
                        ...
                        <textarea class="form-control" name="description" rows="5"
                                  placeholder="Описание"><?php echo $product->description; ?></textarea>
                        <br>
                        <p>
                            <small>Дата создания:
                    ...
                    <div class="col-12 col-md-3" id="sidebar">
                        <div class="admin-sidebar-addnew ">
                            ...
                            <br>
                            <br>
                            <button class="btn btn-primary btn-sm" name="updateProduct" type="submit">Сохранить</button>
                            <button class="btn btn-danger btn-sm" name="deleteProduct" type="submit">Удалить</button>
                        </div>
                    </div>
                ...
                <div class="row row-offcanvas row-offcanvas-right">
                    <div class="col-12 col-md-9">
                        <input name="title" class="form-control form-control-lg" type="text"
                               placeholder="Название" value="<?php echo $title; ?>" required>
                        <br>
                        <div class="form-row">
                            <div class="col-md-6 input-group">
                                <div class="input-group-prepend">
                                ...
                                <input name="price" class="form-control " type="number" step="any"
                                       min="0.1"
                                       placeholder="Цена" value="<?php echo $price; ?>" required>
                            </div>
                            <div class="col-md-6 input-group">
                                <select name="category" class="custom-select " required>
                                    <option value="">...</option>
                    ...
                    <div class="col-6 col-md-3" id="sidebar">
                        <div class="admin-sidebar-addnew ">
                            ...
                            <br>
                            <br>
                            <button class="btn btn-primary btn-sm" name="addProduct" type="submit">Добавить</button>
                        </div>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="table-responsive">
                <table class="table table-admin table-striped table-sm">
                    <caption>Список всех товаров</caption>
                    <thead>
                    <tr>
                        <th>№</th>
                        <th>Название</th>
