...
class CategoryAdmin extends BaseController {
    ...
    public function showEdit($id) {
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            <h2 class="admin-title">Редактирование категории</h2>
                ...
                <div class="row row-offcanvas row-offcanvas-right">
                    <div class="col-12 col-md-9">
                        <input class="form-control form-control-lg" type="text" name="title"
                               placeholder="Введите название категории" value="<?php echo $category->title; ?>">
                        <br>
                        <textarea class="form-control" name="description" rows="5"
                                  placeholder="Описание"><?php echo $category->description; ?></textarea>
                        <br>
                        <p>
                            <small>Дата создания:
                        ...
                        <div class="admin-sidebar-addnew ">
                            ...
                            <div class="col-sm-12 admin-preview-img">
                                ...
                                <label id="removeImgCat"
                                       class="admin-btn-remove <?php echo !$image ? "admin-hide" : "" ?>">Удалить</label>
                            </div>
                            <br>
                            <br>
                            <button class="btn btn-primary btn-sm" name="updateCategory" type="submit">Сохранить</button>
                            <button class="btn btn-danger btn-sm" name="deleteCategory" type="submit">Удалить</button>
                        </div>
    ...
    public function showAddNew() {
        ...
        ?>
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            <h2 class="admin-title">Создание категории</h2>
            <form class="form-add-new" method="post" action="?name=admin-area&category&add-new"
                ...
                <div class="row row-offcanvas row-offcanvas-right">
                    <div class="col-12 col-md-9">
                        <input class="form-control form-control-lg" type="text" name="title"
                               placeholder="Введите название категории" value="<?php echo $title; ?>">
                        <br>
                        <textarea class="form-control" name="description" rows="5"
                                  placeholder="Описание"><?php echo $desc; ?></textarea>
                    </div>
                    ...
                    <div class="col-6 col-md-3" id="sidebar">
                        <div class="admin-sidebar-addnew ">
                            ...
                            <div class="col-sm-12 admin-preview-img">
                                ...
                                <label id="removeImgCat" class="admin-btn-remove admin-hide">Удалить</label>
                            </div>
                            <br>
                            <br>
                            <button class="btn btn-primary btn-sm" name="addCategory" type="submit">Создать</button>
                        </div>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <div class="table-responsive">
                <table class="table table-admin table-striped table-sm">
                    <caption>Список всех категорий</caption>
                    <thead>
                    <tr>
                        <th scope="col">№</th>
